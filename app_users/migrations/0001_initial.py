    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count_buy', models.PositiveIntegerField(default=0, verbose_name='count_buy')),
                ('status', models.CharField(choices=[('b', 'Brose'), ('s', 'Silver'), ('g', 'Gold')], default='b', max_length=1)),
                ('used_funds_counter', models.PositiveIntegerField(default=0, verbose_name='used_funds_counter')),
